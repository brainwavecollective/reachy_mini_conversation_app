...
1. Fork and clone the repo:
   ```bash
   git clone https://github.com/pollen-robotics/anima_conversation_app
   cd anima_conversation_app
   ```
...
- Every push to the `main` branch is automatically synchronized to [pollen-robotics/anima_conversation_app](https://huggingface.co/spaces/pollen-robotics/anima_conversation_app)
